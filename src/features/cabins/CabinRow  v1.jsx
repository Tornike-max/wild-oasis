        ...
        <div>
          ...
          <Modal>
            ...
            <Modal.Open opens='delete'>
              <button disabled={isDeleting} onClick={() => deleteCabinMutate(id)}><HiTrash /></button>
            </Modal.Open>
            <Modal.Window name='delete'>
              <ConfirmDelete resourceName='Cabin' disabled={isDeleting} onConfirm={() => deleteCabinMutate(id)} />
            </Modal.Window>
          </Modal>
          ...
          <Menus.Menu>
            ...
            <Menus.List id={id}>
              ...
              <Menus.Button onClick={() => deleteCabinMutate(id)} icon={<HiTrash />}>Delete</Menus.Button>
            </Menus.List>
